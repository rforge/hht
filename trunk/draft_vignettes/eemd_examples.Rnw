...
%\VignetteIndexEntry{Ensemble Empirical Mode Decomposition}
\usepackage{placeins}
\usepackage{amsmath}
\begin{document}
...
The first signal is the same as Section 3 in the vignette titled ``Investigating some Interesting Signals with Hilbert and Fourier Spectrograms.''
In this example, I demonstrate how the EEMD can improve the quality of intrinsic mode functions (IMFs), particularly at the beginning and end of the signal.
...
The vignette titled ``Investigating some Interesting Signals with Hilbert and Fourier Spectrograms'' examines the EMD of the following signal:
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=1\textwidth]{nonlinstaemd.png}
\end{center}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=1\textwidth]{nonlinstarand.png}
\end{center}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=1\textwidth]{nonlinstasift.png}
\end{center}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=1\textwidth]{modemix.png}
\end{center}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=1\textwidth]{modemixht.png}
\end{center}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=1\textwidth, angle=90]{stackedeemdimfs.png}
\end{center}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=1\textwidth]{stackedeemdht.png}
\end{center}
...
One of these events (and its 10 trial EEMD) has been included as an example data set in this R package.
This vignette regenerates this EEMD, but with 100 trials.
...
fgram_image(ft, time_span, freq_span, amp_span)
@
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=1\textwidth, angle=90]{pferesift.png}
\end{center}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=1\textwidth]{pfeht.png}
\end{center}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=1\textwidth]{pfeft.png}
\end{center}
