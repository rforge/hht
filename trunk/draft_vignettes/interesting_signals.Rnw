...
<<label=stacked1imfscode,include=FALSE>>=
time_span=c(0,50)
imf_list=1:4
os=TRUE
res=FALSE
...
<<label=stacked1farhgramcode,include=FALSE>>=
...
<<label=stacked1ftcode, include=FALSE>>=
ft=list()
ft$nfft=4096
ft$ns=10/dt
ft$nov=ft$ns - ft$ns * 0.002
amp_span=c(100,800)
ftgram_image(sig, dt, ft, time_span, freq_span, amp_span,
    img_x_format = "%.0f", img_y_format = "%.0f",
...
\begin{figure}[ht]
\begin{center}
<<label=stacked1imfs, fig=TRUE, echo=FALSE>>=
<<stacked1imfscode>>
@
\end{center}
...
\begin{figure}[ht]
\begin{center}
<<label=stacked1farhgram, fig=TRUE, echo=FALSE>>=
<<stacked1farhgramcode>>
@
\end{center}
...
\begin{figure}[ht]
\begin{center}
<<label=stacked1ft, fig=TRUE, echo=FALSE>>=
<<stacked1ftcode>>
@
\end{center}
...
<<label=stacked2imfcode, include=FALSE>>=
library(hht)
dt=0.05
tt = seq(dt, 50, by = dt)
...
<<label=stacked2htcode, include=FALSE>>=
freq_span = c(0, 4)
sdt=0.1
dfreq = 0.1
...
<<label=stacked2ftcode, include=FALSE>>=
ft=list()
ft$nfft=4096
ft$ns=300
ft$nov=290
...
\begin{figure}[ht]
\begin{center}
<<label=stacked2imf, fig=TRUE, echo=FALSE>>=
<<stacked2imfcode>>
@
\end{center}
...
\begin{figure}[ht]
\begin{center}
<<label=stacked2ht, fig=TRUE, echo=FALSE>>=
<<stacked2htcode>>
@
\end{center}
...
\begin{figure}[ht]
\begin{center}
<<label=stacked2ft, fig=TRUE, echo=FALSE>>=
<<stacked2ftcode>>
@
\end{center}
...
freq_span = c(0, 2)
amp_span=c(100,500)
ftgram_image(sig, dt, ft, freq_span = freq_span,
